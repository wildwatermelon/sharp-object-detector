...
def generate(opt):
    ...
    if not os.path.exists("./input_test/ground-truth"):
        os.makedirs("./input_test/ground-truth")

    for image_id in image_ids:
        with open("./input_test/ground-truth/" + image_id + "_ground_truth.json", "w") as outfile:
            bounding_boxes = []
            root = ET.parse(
