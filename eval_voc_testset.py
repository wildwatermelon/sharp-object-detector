...
GT_PATH = os.path.join(os.getcwd(), "input_test", "ground-truth")
DR_PATH = os.path.join(os.getcwd(), "input_test", "detection-results")

# insert validation images into images-optional
IMG_PATH = os.path.join(os.getcwd(), "input_test", "images-optional")
...
"""
eval_gt_file_testset.generate(eval_gt_file_testset.get_args())
"""
 ground-truth
"""
...
"""
 update file direcotry
"""
TEMP_FILES_PATH = os.path.join(os.getcwd(), "input_test", ".temp_files")
# shutil.rmtree(TEMP_FILES_PATH)
if not os.path.exists(TEMP_FILES_PATH):  # if it doesn't exist already
    os.makedirs(TEMP_FILES_PATH)
results_files_path = os.path.join(os.getcwd(), "input_test", "results")
...
with open(results_files_path + "/results.txt", "w") as results_file:
    ...
    for class_index, class_name in enumerate(gt_classes):
        ...
        for idx, detection in enumerate(dr_data):
            ...
            gt_file = GT_PATH + "/" + file_id + "_ground_truth.json"
            print(gt_file)
            ground_truth_data = json.load(open(gt_file))
            ovmax = -1
            gt_match = -1
        ...
        plt.show()
        # save the plot
        fig.savefig(results_files_path +"/classes/"+ class_name + ".png", dpi=fig.dpi)
