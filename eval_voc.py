...
"""
eval_gt_file.generate(eval_gt_file.get_args())
"""
 ground-truth
"""
...
"""
TEMP_FILES_PATH = os.path.join(os.getcwd(), "input", ".temp_files")
# shutil.rmtree(TEMP_FILES_PATH)
if not os.path.exists(TEMP_FILES_PATH):  # if it doesn't exist already
    os.makedirs(TEMP_FILES_PATH)
results_files_path = os.path.join(os.getcwd(), "input", "results")
