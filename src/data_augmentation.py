...
if __name__ == "__main__":
    image = cv2.imread("../test_images/Screenshot_1.jpg")
    image = cv2.cvtColor(image, cv2.COLOR_BGR2RGB)
    object = []
    object.append([1, 1, 1, 1, "a"])
    print(object)
    transformations = Compose([HSVAdjust(), VerticalFlip(), Crop(), Resize(448)])
    # transformations = Compose([Resize(4000)])
    image, object = transformations((image, object))
    print(object)
